...
#include <io/net/mtcp_client.h>
#include <io/net/mtcp_server.h>
...
public:
	...
	: log_("/connector"),
	  ...
	  action_(NULL)
	{
		test_ = new Test(group_, "mTCPClient::connect");
		SocketEventCallback *cb =
			callback(this, &Connector::connect_complete);
		action_ = mTCPClient::connect(SocketImplOS, family, remote, cb);
	}
